    ...
    <link rel="stylesheet" type="text/css" href="css/widget-cartPanelView.css" />
       ...
       <script type="text/javascript"  src="plugins/angularjs/angular.min.js"></script>
	    ...
	    <script type="text/javascript"  src="js/controller/itemController.js"></script>
	     <script>
	    	var skuList=[
	    		    <#list items as itemsList>
					  {
						 "id":${itemsList.id?c},
						 "title":"${itemsList.title!''}",
						 "price":${itemsList.price?c}, 
						 "spec": ${itemsList.spec}
			 		},
	    			</#list>
	    			];
							...
							<#if imageList?size !=0>
								<#if imageList[0]??>
									<img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="400px" height="400px"  />
										<#else>
										<img jqimg="${imageList[1].url}" src="${imageList[1].url}" />
								</#if>
							</#if>
							</span>
						</div>
						...
						<#list specificationList as spec>
							<dl>
								...
								<#-- <dd><a href="javascript:;">金色<span title="点击取消选择">&nbsp;</span>  </a></dd>-->
									...
									<#list  spec.attributeValue as vas>
										<dd>
											<a href="javascript:;"  class="{{facks('${spec.attributeName}','${vas}')?'selected':''}}"  ng-click="select('${spec.attributeName}','${vas}')">${vas}<span ng-if="facks('${spec.attributeName}','${vas}')" title="点击取消选择">&nbsp;</span></a>
										</dd>
									</#list>
							</dl>
							</#list>
							...
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										...
										<a href="javascript:void(0)" ng-click="nums(1)" class="increment plus">+</a>
										<a href="javascript:void(0)" ng-click="nums(-1)" class="increment mins">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="cart.html" ng-click="gouwuche()"  target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
